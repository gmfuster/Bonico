    ...
    render() {
        ...
        <React.Fragment>            
            ...
            <div className="MainSectionContainerActivities">
                ...
                <h1 className="sectionHeaderPink" id="KidsSection">K. General</h1>
                ...
                <h1 className="sectionHeaderPink" id="KidsSection">K. Language</h1>
                <div className="MainSectionContainer" >   
                ...
                <h1 className="sectionHeaderPink" id="KidsSection">K. Math</h1>
                <div className="MainSectionContainer" >   
                    <div className="cardDiv">
                        <Link to={path + "/Counting"} className="CardTextLink">                                                    
                            <img src= {path + "/images/MainItemCardImages/Counting.svg"} className="MainSectionItemImage" alt="Count up to 99"></img>   
                        </Link>
                    </div>
                    <div className="cardDiv">
                    ...
                    <div className="cardDiv">
                        <Link to={path + "/Subtraction" } className="CardTextLink">                                                    
                            <img src= {path + "/images/MainItemCardImages/Subtraction.svg"} className="MainSectionItemImage" alt="Subtraction"></img>   
                        </Link>
                    </div>
                    <div className="cardDiv">
                        <Link to={path + "/NumberBonds" } className="CardTextLink">                                                    
                            <img src= {path + "/images/MainItemCardImages/NumberBonds.svg"} className="MainSectionItemImage" alt="Number Bonds"></img>   
                        </Link>
                    </div>
                    <div className="cardDiv">
